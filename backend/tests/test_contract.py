...
class TestT22DemoData:
    ...
    def test_load_priority_realism(self) -> None:
        ...
        for hour in payload["hours"][:3]:
            ...
            # Flexible tiers scale up P2 < P3 < P4. P1 magnitude is independent:
            # DATA_CONTRACT.md section 4.9 example has P1 largest (8 > 5, 7, 2).
            assert p2 < p3 < p4, (
                f"Flexible demand must scale P2 < P3 < P4 at hour {hour['hour_index']}"
            )
